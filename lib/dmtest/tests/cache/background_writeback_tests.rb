...
class BackgroundWritebackTests < ThinpTestCase
  ...
  def clean_data_never_gets_written_back(policy, metadata_version)
  ...
  define_tests_across(:clean_data_never_gets_written_back,
  ...
  define_tests_across(:dirty_data_always_gets_written_back,
                      POLICY_NAMES, METADATA_VERSIONS)

  #--------------------------------

  def cache_remains_clean_through_reload(policy, metadata_version)
    cache_size = gig(1)
    block_size = k(64)
  ...
  define_tests_across(:cache_remains_clean_through_reload,
                      POLICY_NAMES, METADATA_VERSIONS)
